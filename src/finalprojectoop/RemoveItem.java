...
public class RemoveItem extends javax.swing.JFrame {
    ...
    private void submitBTNActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_submitBTNActionPerformed
        if (barcodeTF.getText().matches("\\d{3,6}") && quantityTF.getText().matches("\\d*") && Integer.valueOf(quantityTF.getText())>0) {
            if (FinalProjectOOP.customer.removeItem(barcodeTF.getText(), Integer.valueOf(quantityTF.getText()), FinalProjectOOP.cart, FinalProjectOOP.inventory)) {
                this.setVisible(false);
            } else {
                //ITEM NOT AVIALABLE IN CART//
                Error error = new Error();
                error.errorLB.setText("Item not in cart");
